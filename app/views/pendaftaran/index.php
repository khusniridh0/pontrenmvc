...
<!-- pembuka -->
    ...
    <section id="profil" class="profil">
        <h2 class="d-flex justify-content-center text-shadow mt-5">Unit Pendidikan</h2>
...
<!-- pendiri -->
    <section id="pendiri" class="pendiri">
        <h2 class="d-flex justify-content-center text-shadow mt-5">Pendidikan Extra Kulikuler</h2>
...
<!-- susunan pengurus yayasan -->    
    <section id="pengurus" class="pengurus">
        <h2 class="d-flex justify-content-center text-shadow mt-5">Fasilitas Pendidikan</h2>
        <hr width="15%" color="#000" class="mb-5">
